...
function(vcpkg_build_autotools)
    ...
    foreach(BUILDTYPE "debug" "release")
        if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL BUILDTYPE)
            ...
            execute_process(
                COMMAND make ${PARALLEL_ARG} ${TARGET_PARAM}
            ...
            if(error_code)
                ...
                if(error_code)
                    ...
                    endforeach()
                    set(_eb_COMMAND make ${PARALLEL_ARG} ${TARGET_PARAM})
            ...
            message(STATUS "${STATUS_MESSAGE} ${TARGET_TRIPLET}-${SHORT_BUILDTYPE} done")
            if(_bc_ADD_BIN_TO_PATH)
